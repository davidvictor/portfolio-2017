	...
	return (
		<div className={classes}>
			<Project
				...
				contribution="ESC came to Lionhouse (my dev shop) for web technology to match the level of scientific service they provide to their clients. Laboratory analyses spawns absurd amounts of data, and laboratories are constantly faced with the problem of how best to display this data to their clients. The dashboards  ESC needed for their clients had to be able to mine, summarize, and highlight key points and findings from the data... all in the browser, before React, with performant IE9 as a business requirement. Kids these day will never know that things are easy today compared to just a few short years ago."
