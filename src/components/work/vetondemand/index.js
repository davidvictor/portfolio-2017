	...
	return (
		<div className={classes}>
			<Project
				...
				contribution="While running a small dev shop in Nashville, I was introduced to two brothers who loved their dogs as much as each other. Inspired by a wave of healthcare applications sweeping the industry, we set out to build the first telemedicine platform for veterinary care. It was simple, video chat with a veterinarian. My team lead the product development process from start to finish. We validated the business case with extensive research, partnered with local veterinarians to help guide the roadmap, and built a cross platform telemedicine application strong enough operate in a regulatory and legal landscape even tighter than what our two-legged doctor friends face. Building and running Vet on Demand remains the most valuable experience of my life so far."
